...
public class Pile4Test extends junit.framework.TestCase {
    ...
    public void test_Emplier() throws Exception{
    try{
        p1.empiler(3);
        assertEquals("empiler correcte ? ","[3]" , p1.toString());
        p1.empiler(2);
        assertEquals("empiler correcte ? ","[2, 3]",p1.toString());
        p1.depiler();
        assertEquals("depiler correcte ? ","[3]",p1.toString());
        p1.depiler();
